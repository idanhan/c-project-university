...
class project1Back extends StatefulWidget {
  String proBack = 'pro1Back';

  @override
  State<project1Back> createState() => _project1State();
}

class _project1State extends State<project1Back> {
  File? _selectedImage;
  String? imgstrback;
                        ...
                        ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.of(context).pop(<String, Object>{
                                ...
                                'Imageback':
                                    (_selectedImage) != null ? imgstrback! : '',
